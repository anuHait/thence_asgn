...
function Footer() {
  return (
    <div className='m-5 flex flex-row items-center bg-neutral-100 rounded-[38.8px] h-36 justify-between p-4'>
       ...
       <h1 className='text-md'>Terms & Conditions</h1>
       <h1 className='text-md'>Privacy policy</h1>
       </div>
    </div>
  )
}
